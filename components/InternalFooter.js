...
export default function InternalFooter({theme, decorations}) {
  return (
    <footer className={`
    ...
    `}>
      <section className="container mx-auto flex flex-col sm:flex-row sm:items-center relative">
        ...
        <div className={`${theme === 'light' ? 'text-gray-500' : 'text-gray-300'} flex-1 ${smallTextClasses}`}>
          <p>
          ...
          <div className="flex items-center">
            ...
            <ol className="flex ml-2">
              <li className="mr-1">
                ...
                >
                  <FacebookIcon
                    className={`fill-current ${theme === 'light' ? 'text-gray-500' : 'text-gray-300'} hover:text-gray-700`}
                  />
                </a>
              </li>
              <li className="mr-1">
